...
(() => {
    ...
    const drawIntro = (context) => {
        ...
        context.fillText("2. Load your classes (classes.txt file).", zoomX(20), zoomY(150))
        context.fillText("NOTES:", zoomX(20), zoomY(300))
        context.fillText("1: Reloading images will RESET BBOXES!", zoomX(20), zoomY(400))
        context.fillText("2: Check out README.md for more information.", zoomX(20), zoomY(450))
    }
